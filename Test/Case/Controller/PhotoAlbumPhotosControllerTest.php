<?php
/**
 * PhotoAlbumPhotosController Test Case
 *
...
App::uses('PhotoAlbumPhotosController', 'PhotoAlbums.Controller');

/**
 * Summary for PhotoAlbumPhotosController Test Case
 */
class PhotoAlbumPhotosControllerTest extends ControllerTestCase {
