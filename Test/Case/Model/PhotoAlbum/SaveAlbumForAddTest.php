<?php
/**
 * PhotoAlbumSaveAlbumForAdd Test Case
 *
...
/**
 * Summary for PhotoAlbumSaveAlbumForAddTest Test Case
 */
class PhotoAlbumSaveAlbumForAddTest extends WorkflowSaveTest {
 ...
 * @var string
 */
	protected $_methodName = 'saveAlbumForAdd';
