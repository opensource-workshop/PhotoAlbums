<?php
/**
 * BlockSettingForPhotoAlbumFixture
 *
...
/**
 * Summary for BlockSettingForPhotoAlbumFixture
 */
class BlockSettingForPhotoAlbumFixture extends BlockSettingFixture {
