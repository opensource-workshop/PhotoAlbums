...
Router::connect(
	...
	array(
		'block_id' => '[0-9]+', 'key' => '[0-9a-zA-Z_]+', 'content_id' => '[0-9]+',
...
Router::connect(
	...
	array('block_id' => '[0-9]+', 'key' => '[0-9a-zA-Z_]+', 'content_id' => '[0-9]+')
);

Router::connect(
	'/photo_albums/photo_albums/jacket/:block_id/:key/:size',
	array('plugin' => 'photo_albums', 'controller' => 'photo_albums', 'action' => 'jacket'),
	array('block_id' => '[0-9]+', 'key' => '[0-9a-zA-Z_]+', 'size' => 'big|medium|small|thumb')
);
